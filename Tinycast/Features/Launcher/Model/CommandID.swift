...
enum CommandID: String, CaseIterable, Sendable {
    ...
    case requestFeature = "command:request-feature"
    case featureRequests = "command:feature-requests"
    ...
    var name: String {
        ...
        case .requestFeature: return "Request a Feature"
    ...
    var sfSymbol: String {
        ...
        case .requestFeature: return "hammer"
        case .featureRequests: return "list.bullet.rectangle"
