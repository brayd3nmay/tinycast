enum SettingsTab: CaseIterable, Identifiable {
    case general, applications, systemSettings, systemActions, commands, quicklinks, fallbacks, ai,
        quickActions, featureRequest, fileSearch, notes, snippets, navigation, windowManagement,
        clipboard, emoji, calendar, extensions, permissions, backup, about
...
enum SettingsSection: CaseIterable, Identifiable {
    ...
    var tabs: [SettingsTab] {
        ...
        case .features:
            return [
                .ai, .quickActions, .featureRequest, .fileSearch, .notes, .snippets, .navigation,
